...
public class EntityIDGenerator {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        RegistryProvider.Registry registry = provider.getEntityRegistry();
        ...
        for (Map.Entry<String, Integer> stringIntegerEntry : registry.getData().entrySet()) {
            ...
            content.append("        ").append(key.getKey().toUpperCase()).append("_ID = provider.getEntityRegistry().lookup(\"").append(key.toString()).append("\");").append(NEWLINE);
        }
        ...
        FileWriter writer = new FileWriter("EntityID.java");
