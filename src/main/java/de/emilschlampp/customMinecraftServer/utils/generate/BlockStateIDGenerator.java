...
public class BlockStateIDGenerator {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        content.append("import de.emilschlampp.customMinecraftServer.utils.RegistryProvider;" + NEWLINE + NEWLINE +
                "public class BlockStateID {" + NEWLINE);
        ...
        RegistryProvider.Registry registry = provider.getBlocksRegistry();
        ...
        for (Map.Entry<String, Integer> stringIntegerEntry : registry.getData().entrySet()) {
            ...
            content.append("        ").append(key.getKey().toUpperCase()).append("_ID = provider.getBlocksRegistry().lookup(\"").append(key.toString()).append("\");").append(NEWLINE);
        }
        ...
        FileWriter writer = new FileWriter("BlockStateID.java");
