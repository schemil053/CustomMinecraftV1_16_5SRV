...
public class SlotIDGenerator {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        content.append("import de.emilschlampp.customMinecraftServer.utils.RegistryProvider;" + NEWLINE + NEWLINE +
                "public class ItemSlotID {" + NEWLINE);
        ...
        for (Map.Entry<String, Integer> stringIntegerEntry : provider.getItemRegistry().getData().entrySet()) {
        ...
        for (Map.Entry<String, Integer> stringIntegerEntry : provider.getItemRegistry().getData().entrySet()) {
            ...
            content.append("        ").append(key.getKey().toUpperCase()).append("_ID = provider.getItemRegistry().lookup(\"").append(key.toString()).append("\");").append(NEWLINE);
        }
        ...
        FileWriter writer = new FileWriter("ItemSlotID.java");
